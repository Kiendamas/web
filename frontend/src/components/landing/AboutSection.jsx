  ...
  return (
    <section className="py-16 bg-kiendamas-brown" id="nosotros">
       <div className="w-full px-2 sm:px-4 lg:px-8">
        ...
        {/* Layout responsive: íconos a la izquierda, texto a la derecha en desktop */}
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row md:items-stretch gap-8 md:gap-0">
          ...
          {/* Flecha centrada verticalmente en desktop */}
          <div className="flex justify-center md:items-center mt-10 md:mt-0 md:ml-8 min-h-[320px]">
            <AboutHistoriaButton />
          </div>
        </div>
      </div>
